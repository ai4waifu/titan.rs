    ...
    Entry {
        ...
        instructions: {
            ...
            instructions.extend([
                ...
                PtxInstruction::MulRnF32 {
                    destination: f32(2),
                    left: F32Value::Reg(f32(1)),
                    right: F32Value::ImmBits(0x3F3504F3),
                },
                ...
                PtxInstruction::SubRnF32 {
                    destination: f32(3),
                    left: F32Value::ImmBits(0x00000000),
                    right: F32Value::Reg(f32(3)),
                },
                PtxInstruction::DefineLabel(signed_done.clone()),
                PtxInstruction::MulRnF32 {
                    destination: f32(5),
                    left: F32Value::Reg(f32(3)),
                    right: F32Value::ImmBits(0x3EA7BA05),
                },
                PtxInstruction::AddRnF32 {
                    destination: f32(5),
                    left: F32Value::Reg(f32(5)),
                    right: F32Value::ImmBits(0x3F800000),
                },
                PtxInstruction::DivRnF32 {
                    destination: f32(5),
                    left: F32Value::ImmBits(0x3F800000),
                    right: F32Value::Reg(f32(5)),
                },
                ...
                PtxInstruction::SubRnF32 {
                    destination: f32(7),
                    left: F32Value::ImmBits(0x00000000),
                    right: F32Value::Reg(f32(7)),
                },
                PtxInstruction::MulRnF32 {
                    destination: f32(7),
                    left: F32Value::Reg(f32(7)),
                    right: F32Value::ImmBits(0x3FB8AA3B),
                },
                ...
                PtxInstruction::MulRnF32 {
                    destination: f32(6),
                    left: F32Value::Reg(f32(6)),
                    right: F32Value::ImmBits(0x3F000000),
                },
