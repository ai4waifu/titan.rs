...
pub(super) fn layer_norm_f32(name: Identifier) -> Entry {
    ...
    Entry {
        ...
        instructions: vec![
            ...
            PtxInstruction::LoadParameterF32 { destination: f32(6), parameter: parameter_names[6].clone() },
            ...
            PtxInstruction::MadLoU32 { destination: b32(6), left: b32(3), right: b32(4), addend: b32(5) },
